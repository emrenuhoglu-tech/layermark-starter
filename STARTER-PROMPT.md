...
- **Plan first.** Non-trivial işler için Shift+Tab×2 ile plan mode (Boris: %80 default).
...
Fresh Claude Code session aç (yeni window), problemi tek paragrafta sıfırdan tarif et. Mevcut session'ın context bloat'ından kurtulursun.
=== END FILE: CLAUDE.md ===
